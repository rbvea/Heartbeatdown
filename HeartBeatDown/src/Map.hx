class Map 
{
	...
	private function makeMap1(): Branch
	{
		...
		var n13:Branch = { id : 13, difficulty : 3, left : null, right : null, pointArray : [p23, p20, p12]};
		...
		var n8:Branch  = { id : 8, difficulty : 2, left : null, right : null, pointArray  : [p8, p9, p10, p11, p12]};
		...
		var n6:Branch  = { id : 6, difficulty : 2, left : n8,   right : n9,   pointArray  : [p6, p7, p8]};
